...
@Component({
  selector: 'app-abm-naciones',
  templateUrl: './abm-naciones.component.html',
  styleUrls: ['./abm-naciones.component.scss']
})
export class AbmNacionesComponent implements OnInit {
  ...
  async actualizarDatos(obj: Naciones) {
  ...
  back() {
    this.router.navigate(['/lst-naciones']);
  }
