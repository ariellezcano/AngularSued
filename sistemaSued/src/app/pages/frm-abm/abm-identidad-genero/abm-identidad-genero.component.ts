...
@Component({
  selector: 'app-abm-identidad-genero',
  templateUrl: './abm-identidad-genero.component.html',
  styleUrls: ['./abm-identidad-genero.component.scss']
})
export class AbmIdentidadGeneroComponent implements OnInit {
  ...
  constructor(
    ...
    private wsdl: IdentidadGeneroService,
  ...
  async actualizarDatos(obj: IdentidadGenero) {
  ...
  back() {
    this.router.navigate(['/lst-identidadGenero']);
  }
