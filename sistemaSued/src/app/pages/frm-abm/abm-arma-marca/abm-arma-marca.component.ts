...
@Component({
  selector: 'app-abm-arma-marca',
  templateUrl: './abm-arma-marca.component.html',
  styleUrls: ['./abm-arma-marca.component.scss']
})
export class AbmArmaMarcaComponent implements OnInit {
  ...
  back() {
    this.router.navigate(['/lst-marcas']);
  }
