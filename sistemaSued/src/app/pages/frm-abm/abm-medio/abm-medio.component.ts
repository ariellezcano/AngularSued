...
@Component({
  selector: 'app-abm-medio',
  templateUrl: './abm-medio.component.html',
  styleUrls: ['./abm-medio.component.scss']
})
export class AbmMedioComponent implements OnInit {
  ...
  async actualizarDatos(obj: Medio) {
  ...
  back() {
    this.router.navigate(['/lst-medio']);
  }
}
