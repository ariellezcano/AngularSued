...
@Component({
  selector: 'app-abm-dncp',
  templateUrl: './abm-dncp.component.html',
  styleUrls: ['./abm-dncp.component.scss']
})
export class AbmDncpComponent implements OnInit {
  ...
  async actualizarDatos(obj: DetDnpc) {
