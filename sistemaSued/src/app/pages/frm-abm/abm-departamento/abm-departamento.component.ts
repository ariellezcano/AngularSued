...
export class AbmDepartamentoComponent implements OnInit {
  public id!: number;
  ...
  constructor(
    ...
    private wsdl: DepartamentoService,
  ...
  async actualizarDatos(obj: Departamento) {
  ...
  back() {
    this.router.navigate(['/lst-departamento']);
  }
