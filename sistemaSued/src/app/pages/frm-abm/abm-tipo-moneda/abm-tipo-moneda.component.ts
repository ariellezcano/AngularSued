...
@Component({
  selector: 'app-abm-tipo-moneda',
  templateUrl: './abm-tipo-moneda.component.html',
  styleUrls: ['./abm-tipo-moneda.component.scss']
})
export class AbmTipoMonedaComponent implements OnInit {
  ...
  constructor(
    ...
    private wsdl: TipoMonedaService,
  ...
  async actualizarDatos(obj: TipoMoneda) {
  ...
  back() {
    this.router.navigate(['/lst-tipoMoneda']);
  }
