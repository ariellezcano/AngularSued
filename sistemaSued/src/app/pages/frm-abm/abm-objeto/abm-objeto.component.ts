...
@Component({
  selector: 'app-abm-objeto',
  templateUrl: './abm-objeto.component.html',
  styleUrls: ['./abm-objeto.component.scss']
})
export class AbmObjetoComponent implements OnInit {
  ...
  async actualizarDatos(obj: Objeto) {
  ...
  back() {
    this.router.navigate(['/lst-objeto']);
  }
