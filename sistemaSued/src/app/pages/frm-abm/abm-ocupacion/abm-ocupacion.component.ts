...
@Component({
  selector: 'app-abm-ocupacion',
  templateUrl: './abm-ocupacion.component.html',
  styleUrls: ['./abm-ocupacion.component.scss']
})
export class AbmOcupacionComponent implements OnInit {
  ...
  async actualizarDatos(obj: Ocupacion) {
  ...
  back() {
    this.router.navigate(['/lst-ocupacion']);
  }
}
