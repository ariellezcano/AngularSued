...
@Component({
  selector: 'app-abm-barrio',
  templateUrl: './abm-barrio.component.html',
  styleUrls: ['./abm-barrio.component.scss']
})
export class AbmBarrioComponent implements OnInit {
  ...
  async actualizarDatos(obj: Barrio) {
  ...
  back() {
    this.router.navigate(['/lst-barrio']);
  }
