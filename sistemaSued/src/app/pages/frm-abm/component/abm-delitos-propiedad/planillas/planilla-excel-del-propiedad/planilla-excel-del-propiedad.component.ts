...
import { AbmDelitosPropiedadComponent } from '../../abm-delitos-propiedad.component';
import { PlanillaDelPropiedad } from 'src/app/models/component/models-planillas/planilla-delPropiedad';

@Component({
  selector: 'app-planilla-excel-del-propiedad',
  templateUrl: './planilla-excel-del-propiedad.component.html',
  styleUrls: ['./planilla-excel-del-propiedad.component.scss'],
})
export class PlanillaExcelDelPropiedadComponent implements OnInit {
  @ViewChild(AbmDelitosPropiedadComponent, { static: false })
  fil!: AbmDelitosPropiedadComponent;

  @ViewChild('table', { static: false }) tablaRef!: ElementRef;

  item: PlanillaDelPropiedad;
  items: PlanillaDelPropiedad[];
  exportar: boolean;
  ...
  constructor(
    ...
    this.item = new PlanillaDelPropiedad();
    this.items = [];
    this.exportar = false;
  }
