...
@Component({
  selector: 'app-abm-vehiculo-marca',
  templateUrl: './abm-vehiculo-marca.component.html',
  styleUrls: ['./abm-vehiculo-marca.component.scss']
})
export class AbmVehiculoMarcaComponent implements OnInit {
  public id!: number;
  ...
  constructor(
    ...
    private wsdl: VehiculoMarcaService,
  ...
  async actualizarDatos(obj: VehiculoMarca) {
  ...
  back() {
    this.router.navigate(['/lst-marcasVehiculos']);
  }
}
