...
import { DelitoArt, DetDnpc } from 'src/app/models/index.models';
...
@Component({
  ...
  styleUrls: ['./abm-articulo.component.scss']
})
export class AbmArticuloComponent implements OnInit {
  ...
  async actualizarDatos(obj: DelitoArt) {
  ...
  back() {
    this.router.navigate(['/lst-articulo']);
  }
