...
@Component({
  selector: 'app-abm-estudio',
  templateUrl: './abm-estudio.component.html',
  styleUrls: ['./abm-estudio.component.scss']
})
export class AbmEstudioComponent implements OnInit {
  ...
  async actualizarDatos(obj: Estudio) {
  ...
  back() {
    this.router.navigate(['/lst-estudio']);
  }
}
