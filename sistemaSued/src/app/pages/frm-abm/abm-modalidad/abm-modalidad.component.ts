...
@Component({
  selector: 'app-abm-modalidad',
  templateUrl: './abm-modalidad.component.html',
  styleUrls: ['./abm-modalidad.component.scss']
})
export class AbmModalidadComponent implements OnInit {
  ...
  async actualizarDatos(obj: Modalidad) {
  ...
  back() {
    this.router.navigate(['/lst-modalidad']);
  }
