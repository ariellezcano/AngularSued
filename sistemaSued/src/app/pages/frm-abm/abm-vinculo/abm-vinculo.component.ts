...
@Component({
  selector: 'app-abm-vinculo',
  templateUrl: './abm-vinculo.component.html',
  styleUrls: ['./abm-vinculo.component.scss']
})
export class AbmVinculoComponent implements OnInit {
  ...
  async actualizarDatos(obj: Vinculo) {
  ...
  back() {
    this.router.navigate(['/lst-vinculo']);
  }
}
