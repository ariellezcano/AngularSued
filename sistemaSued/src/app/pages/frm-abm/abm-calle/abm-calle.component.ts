...
@Component({
  selector: 'app-abm-calle',
  templateUrl: './abm-calle.component.html',
  styleUrls: ['./abm-calle.component.scss']
})
export class AbmCalleComponent implements OnInit {
  ...
  async actualizarDatos(obj: Calle) {
  ...
  back() {
    this.router.navigate(['/lst-calle']);
  }
}
