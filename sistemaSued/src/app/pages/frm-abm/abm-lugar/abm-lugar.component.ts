...
import { Calle, Lugar } from 'src/app/models/index.models';
import { LugarService } from 'src/app/services/component/lugar.service';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-abm-lugar',
  templateUrl: './abm-lugar.component.html',
  styleUrls: ['./abm-lugar.component.scss']
})
export class AbmLugarComponent implements OnInit {
  ...
  async actualizarDatos(obj: Lugar) {
  ...
  back() {
    this.router.navigate(['/lst-lugar']);
  }
}
