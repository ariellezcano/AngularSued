...
@Component({
  selector: 'app-filtro-nacionalidad',
  templateUrl: './filtro-nacionalidad.component.html',
  styleUrls: ['./filtro-nacionalidad.component.scss']
})
export class FiltroNacionalidadComponent implements OnInit {

  @Output()
  filter: EventEmitter<Naciones> = new EventEmitter<Naciones>();
  ...
  enviar(item: Naciones) {
    this.filter.emit(item);
  }

  compareFn(c1: Naciones, c2: Naciones): boolean {
