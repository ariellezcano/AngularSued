...
@Component({
  selector: 'app-filtro-objeto',
  templateUrl: './filtro-objeto.component.html',
  styleUrls: ['./filtro-objeto.component.scss']
})
export class FiltroObjetoComponent implements OnInit {

  @Output()
  filter: EventEmitter<Objeto> = new EventEmitter<Objeto>();
  ...
  constructor(private wsdl: ObjetoService) {
    this.proccess = false;
    this.limit = 5;
    this.paginaActual = 1;
  ...
  compareFn(c1: Objeto, c2: Objeto): boolean {
