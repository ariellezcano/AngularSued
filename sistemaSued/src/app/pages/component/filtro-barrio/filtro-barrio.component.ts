...
@Component({
  selector: 'app-filtro-barrio',
  templateUrl: './filtro-barrio.component.html',
  styleUrls: ['./filtro-barrio.component.scss']
})
export class FiltroBarrioComponent implements OnInit {

  @Output()
  filter: EventEmitter<Barrio> = new EventEmitter<Barrio>();
  ...
  compareFn(c1: Barrio, c2: Barrio): boolean {
