...
@Component({
  selector: 'app-fil-modelo-vehiculo',
  templateUrl: './fil-modelo-vehiculo.component.html',
  styleUrls: ['./fil-modelo-vehiculo.component.scss']
})
export class FilModeloVehiculoComponent implements OnInit {
