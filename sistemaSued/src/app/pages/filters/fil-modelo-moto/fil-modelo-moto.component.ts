...
@Component({
  selector: 'app-fil-modelo-moto',
  templateUrl: './fil-modelo-moto.component.html',
  styleUrls: ['./fil-modelo-moto.component.scss']
})
export class FilModeloMotoComponent implements OnInit {
