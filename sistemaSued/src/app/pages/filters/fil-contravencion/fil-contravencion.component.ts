...
@Component({
  selector: 'app-fil-contravencion',
  templateUrl: './fil-contravencion.component.html',
  styleUrls: ['./fil-contravencion.component.scss']
})
export class FilContravencionComponent implements OnInit {

  @Output() emmit: EventEmitter<Contravencion[]> = new EventEmitter();
  ...
  constructor(private wsdl: ContravencionService) {
    this.busqueda = '';
    this.items = [];
