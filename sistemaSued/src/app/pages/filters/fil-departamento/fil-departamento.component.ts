...
@Component({
  selector: 'app-fil-departamento',
  templateUrl: './fil-departamento.component.html',
  styleUrls: ['./fil-departamento.component.scss']
})
export class FilDepartamentoComponent implements OnInit {
  @Output() emmit: EventEmitter<Departamento[]> = new EventEmitter();
