...
@Component({
  selector: 'app-fil-sexo',
  templateUrl: './fil-sexo.component.html',
  styleUrls: ['./fil-sexo.component.scss']
})
export class FilSexoComponent implements OnInit {

  @Output() emmit: EventEmitter<Sexo[]> = new EventEmitter();
