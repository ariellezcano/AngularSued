...
@Component({
  selector: 'app-fil-vinculo',
  templateUrl: './fil-vinculo.component.html',
  styleUrls: ['./fil-vinculo.component.scss']
})
export class FilVinculoComponent implements OnInit {

  @Output() emmit: EventEmitter<Vinculo[]> = new EventEmitter();
