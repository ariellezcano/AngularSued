...
@Component({
  selector: 'app-fil-modalidad',
  templateUrl: './fil-modalidad.component.html',
  styleUrls: ['./fil-modalidad.component.scss']
})
export class FilModalidadComponent implements OnInit {
  @Output() emmit: EventEmitter<Modalidad[]> = new EventEmitter();
