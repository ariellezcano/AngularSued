...
@Component({
  selector: 'app-fil-objeto',
  templateUrl: './fil-objeto.component.html',
  styleUrls: ['./fil-objeto.component.scss']
})
export class FilObjetoComponent implements OnInit {

  @Output() emmit: EventEmitter<Objeto[]> = new EventEmitter();
