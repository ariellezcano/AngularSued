...
@Component({
  selector: 'app-fil-ocupacion',
  templateUrl: './fil-ocupacion.component.html',
  styleUrls: ['./fil-ocupacion.component.scss']
})
export class FilOcupacionComponent implements OnInit {

  @Output() emmit: EventEmitter<Ocupacion[]> = new EventEmitter();
