...
@Component({
  selector: 'app-fil-identidad-genero',
  templateUrl: './fil-identidad-genero.component.html',
  styleUrls: ['./fil-identidad-genero.component.scss']
})
export class FilIdentidadGeneroComponent implements OnInit {

  @Output() emmit: EventEmitter<IdentidadGenero[]> = new EventEmitter();
