...
@Component({
  selector: 'app-fil-arma-marca',
  templateUrl: './fil-arma-marca.component.html',
  styleUrls: ['./fil-arma-marca.component.scss']
})
export class FilArmaMarcaComponent implements OnInit {
