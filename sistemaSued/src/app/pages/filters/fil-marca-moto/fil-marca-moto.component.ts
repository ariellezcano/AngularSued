...
@Component({
  selector: 'app-fil-marca-moto',
  templateUrl: './fil-marca-moto.component.html',
  styleUrls: ['./fil-marca-moto.component.scss']
})
export class FilMarcaMotoComponent implements OnInit {

  @Output() emmit: EventEmitter<MarcaMoto[]> = new EventEmitter();
