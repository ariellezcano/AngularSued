...
@Component({
  selector: 'app-fil-estudio',
  templateUrl: './fil-estudio.component.html',
  styleUrls: ['./fil-estudio.component.scss']
})
export class FilEstudioComponent implements OnInit {

  @Output() emmit: EventEmitter<Estudio[]> = new EventEmitter();
