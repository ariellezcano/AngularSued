...
@Component({
  selector: 'app-fil-tipo-moneda',
  templateUrl: './fil-tipo-moneda.component.html',
  styleUrls: ['./fil-tipo-moneda.component.scss']
})
export class FilTipoMonedaComponent implements OnInit {

  @Output() emmit: EventEmitter<TipoMoneda[]> = new EventEmitter();
