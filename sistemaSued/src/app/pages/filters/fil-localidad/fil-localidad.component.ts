...
@Component({
  selector: 'app-fil-localidad',
  templateUrl: './fil-localidad.component.html',
  styleUrls: ['./fil-localidad.component.scss']
})
export class FilLocalidadComponent implements OnInit {
