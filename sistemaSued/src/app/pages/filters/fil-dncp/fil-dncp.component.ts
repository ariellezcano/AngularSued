...
@Component({
  selector: 'app-fil-dncp',
  templateUrl: './fil-dncp.component.html',
  styleUrls: ['./fil-dncp.component.scss']
})
export class FilDncpComponent implements OnInit {

  @Output() emmit: EventEmitter<DetDnpc[]> = new EventEmitter();
