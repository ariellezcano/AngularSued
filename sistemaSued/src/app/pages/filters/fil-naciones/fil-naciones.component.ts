...
@Component({
  selector: 'app-fil-naciones',
  templateUrl: './fil-naciones.component.html',
  styleUrls: ['./fil-naciones.component.scss']
})
export class FilNacionesComponent implements OnInit {

  @Output() emmit: EventEmitter<Naciones[]> = new EventEmitter();
