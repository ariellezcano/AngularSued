...
@Component({
  selector: 'app-fil-lugar',
  templateUrl: './fil-lugar.component.html',
  styleUrls: ['./fil-lugar.component.scss']
})
export class FilLugarComponent implements OnInit {

  @Output() emmit: EventEmitter<Lugar[]> = new EventEmitter();
