...
@Component({
  selector: 'app-lst-medio',
  templateUrl: './lst-medio.component.html',
  styleUrls: ['./lst-medio.component.scss']
})
export class LstMedioComponent implements OnInit {
  ...
  linkear(id?: Number) {
    this.router.navigateByUrl('lst-medio/abm/' + id);
  }
